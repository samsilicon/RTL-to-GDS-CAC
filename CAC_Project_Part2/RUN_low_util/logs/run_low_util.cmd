...
#  Created on Sun Nov  9 03:35:04 2025                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.45088 -from {0x17f8 0x17fb} -to 0x17fc -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.45088 -from {0x17ff 0x1802} -to 0x1803 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.45088 -from 0x1805 -to 0x1806
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.45088 -from 0x1809 -to 0x180a
setPathGroupOptions reg2reg_tmp.45088 -effortLevel high
reset_path_group -name reg2out_tmp.45088
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.45088
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.45088
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.45088
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.45088 -from {0x1814 0x1817} -to 0x1818 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.45088 -from {0x181b 0x181e} -to 0x181f -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.45088 -from 0x1821 -to 0x1822
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.45088 -from 0x1825 -to 0x1826
setPathGroupOptions reg2reg_tmp.45088 -effortLevel high
reset_path_group -name reg2out_tmp.45088
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.45088
