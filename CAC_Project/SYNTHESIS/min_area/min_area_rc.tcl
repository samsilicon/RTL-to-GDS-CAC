# --- Synthesis Script for Minimum Area (CAC Project) ---
...
read_sdc minareaconstraints.sdc
...
write_hdl > ./reports/cac_netlist_minarea.v

# Write out the SDC file for the next stages (Place & Route)
write_sdc > ./reports/cac_constraints_minarea.sdc

# Generate synthesis reports
report gates > ./reports/cac_cell_report_minarea.rep
report timing > ./reports/cac_timing_report_minarea.rep
report area > ./reports/cac_area_report_minarea.rep
report power > ./reports/cac_power_report_minarea.rep
